...
\begin{enumerate}
    \item \textbf{نوت‌بوک اصلی پروژه} با ساختار \lr{Q1} تا \lr{Q17} و بخش \lr{Capstone}.
...
\section*{۳) ساختار نمره‌دهی (۲۳۰ نمره)}
\begin{center}
...
I & توسعه حرفه‌ای پایش تولید (کالیبراسیون، درفت، ریکورس) & ۳۰ \\
J (Bonus) & افزونه‌های پژوهشی/تولیدی پیشرفته & +۲۰ \\
\midrule
\textbf{جمع بلوک‌های اصلی} &  & \textbf{۲۳۰} \\
...
\subsection*{بلوک I -- توسعه حرفه‌ای پایش تولید (۳۰ نمره)}
