...
1. نوت‌بوک یکپارچه و قابل اجرا (Q1 تا Q20 + Capstone)
...
| H | کپستون یکپارچه | 25 |
| I | توسعه حرفه‌ای پایش تولید و تحلیل پیشرفته (Q15 تا Q20) | 60 |
| J (Bonus) | افزونه‌های پژوهشی/تولیدی پیشرفته | +20 |
| **جمع بلوک‌های اصلی** |  | **260** |
| امتیاز تشویقی |  | **+20** |
...
### بلوک I: توسعه حرفه‌ای پایش تولید و تحلیل پیشرفته (60)
...
### Q18) Temporal Backtesting و Rolling Validation (10)
- اجرای ارزیابی زمانی fold-by-fold (یا fallback مستند در نبود زمان معتبر)
- گزارش AUC/F1 هر fold و افت عملکرد نسبت به fold اول
- تحلیل همزمان drift proxy و performance decay

### Q19) Uncertainty Quantification (10)
- پیاده‌سازی conformal یا روش معتبر معادل برای بازه/امتیاز اطمینان
- گزارش empirical coverage در سطوح مختلف confidence
- تحلیل interval width و under-coverage

### Q20) Fairness Mitigation Experiment (10)
- محاسبه baseline fairness metrics زیرگروهی
- اجرای مداخله (مثلاً reweighing) و مقایسه قبل/بعد
- بررسی fairness-performance tradeoff با قید سیاستی صریح (مثل سقف افت AUC)
